...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2021 at 06:26 PM
...
(22, 'Gents', 'it will contain latest collection for mens', 1),
(26, 'Ladies', '', 1),
(27, 'Kids', 'it will contain latest collection for kids.', 1),
(28, 'Skincare', '', 1),
(29, 'Groceries', 'its contain safe food and things', 1),
(30, 'Machine', '', 1),
(31, 'Others', '', 1);
...
(16, 'Black Dress', 99, '', 26, 'p-04.jpg', 1),
(17, 'Fairy dress', 121, '', 26, 'p-31.jpg', 1),
(18, 'Pink Dress', 78, '', 26, 'p-35.jpeg', 1),
(19, 'Watch', 563, '', 30, 'p-32.jpg', 1),
(20, 'Beans', 33, '', 29, 'p-14.jpg', 1),
(21, 'Juice', 12, '', 29, 'p-08.jpg', 1),
(22, 'Juice', 12, '', 29, 'p-30.jpg', 1),
(23, 'Dry fruits', 40, '', 29, 'p-16.jpg', 1),
(24, 'Shirt', 99, '', 22, 'pic.jpg', 1),
(25, 'Shirt', 78, '', 22, 'avatar-1.jpg', 1),
(26, 'T-Shirt', 55, '', 22, 'avatar-3.jpg', 1),
(27, 'Glasses', 44, '', 22, 'user.png', 1),
(28, 'T-Shirt', 55, '', 22, 'avatar-3.jpg', 1),
(29, 'Shirt', 78, '', 22, 'avatar-1.jpg', 1),
(30, 'Juice', 12, '', 29, 'thumb-02.jpg', 1);
...
(5, 'asifur', 'asifur', 'rahman', 'test@gmail.com', '202cb962ac59075b964b07152d234b70', 2147483647, 5);
...
--
ALTER TABLE `category`
  MODIFY `ctg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
