                                            ...
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-yellow order-card">
                                                    <div class="card-block">
                                                        ...
                                                        <h2 class="text-right"><i class="ti-reload f-left"></i><span>Tk42,562</span></h2>
                                                        <p class="m-b-0">This Month<span class="f-right">Tk5,032</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xl-3">
                                                <div class="card bg-c-pink order-card">
                                                    <div class="card-block">
                                                        ...
                                                        <h2 class="text-right"><i class="ti-wallet f-left"></i><span>Tk9,562</span></h2>
                                                        <p class="m-b-0">This Month<span class="f-right">Tk542</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- order-card end -->
